...
<xsl:variable name="only-tei-lite-elements">true</xsl:variable>
...
<xsl:template name="gen-text-nodes">
    <xsl:call-template name="text-nodes">
        <xsl:with-param name="node-name">ANY</xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="before-next-element" />
    <xsl:call-template name="text-nodes">
        <xsl:with-param name="node-name">Character data only</xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="before-next-element" />
    <xsl:call-template name="text-nodes">
        <xsl:with-param name="node-name">Empty element</xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="before-next-element" />
    <xsl:call-template name="text-nodes">
        <xsl:with-param name="node-name">character data</xsl:with-param>
    </xsl:call-template>
    <xsl:call-template name="after-last-element" />
</xsl:template>
...
<xsl:template match="/">
{
    ...
    <xsl:call-template name="gen-text-nodes" />
}
</xsl:template>
